...
let cadena = "cadena de texto (string) para testeo";
let palabra1 = "cadena";
let palabra2 = "objeto";
let palabra3 = "testeo";
...
document.write(`<div class="recuadro">
	<h3>MÉTODOS DE CADENAS Y ARRAYS <br> Variables para testeo</h3>
	<em>
...
//startsWith()
document.write("<br><h2>startsWith()</h2>El método <b>startsWith(stringBuscado, posición)</b> indica si una cadena de texto comienza con los caracteres de una cadena de texto concreta que pasamos por parámetros. Devolviendo true o false según corresponda.<br> La posición de inicio es un parámetro opcional y por defecto es 0");
document.write(`<hr>
...
//endsWith()
document.write( "<h2>endsWith()</h2>El método <b>endsWith(stringBuscado, posición)</b> es el opuesto a startsWith. Indica si una cadena de texto finaliza con los caracteres de una cadena de texto concreta que pasamos por parámetros. Devolviendo true o false según corresponda. <br> La posición de inicio es un parámetro opcional y por defecto es 0");
...
//includes()
document.write( "<h2>includes()</h2> El método includes(stringBuscado, posición) determina si una matriz incluye un determinado elemento, devuelve true o false según corresponda. <br> La posición de inicio es un parámetro opcional y por defecto es 0.");
document.write(` <br> <hr>
...
//lastIndexOf()
document.write( "<h2>lastIndexOf()</h2> Recorre el array o string de derecha a izquierda y retorna el primer índice en el que se puede encontrar el elemento pasaado por parámetro dentro del array o cadena de texto, retorna -1 si el elemento no esta presente.<br> La posición de inicio es un parámetro opcional y por defecto es 0");
document.write(` <br> <hr>
...
//padStart()
document.write( "<h2>padStart()</h2> Rellena la cadena actual con una cadena pasada por parámetros (repetida eventualmente) de modo que la cadena resultante alcance una longitud pasada por parámetros. El relleno es aplicado desde el inicio (izquierda) de la cadena actual.");
document.write(` <br> <hr>
...
//padEnd()
document.write( "<h2>padEnd()</h2> Rellena la cadena actual con una cadena pasada por parámetros (repetida eventualmente) de modo que la cadena resultante alcance una longitud pasada por parámetros. El relleno es aplicado desde el final (derecha) de la cadena actual.");
document.write(` <br> <hr>
...
//repeat()
document.write( "<h2>repeat()</h2> Construye y devuelve una nueva cadena que contiene el número especificado de copias de la cadena en la cual fue llamada, concatenados. El parámetro debe ser un entero entre 0 y +∞: [0, +∞), indicando el número de veces a repetir la cadena en la nueva cadenada creada que será devuelta.");
...
//split()
document.write( `<h2>split()</h2> Divide un objeto de tipo String en un array de cadenas mediante la separación de la cadena original en subcadenas. <br> El método split() devuelve el nuevo array con la cantidad con la longitud indicada por parámetro (opcional), si se omite se devuelven todos los índices que se generen del string`);
...
document.write( `<h2>substring()</h2>
	...
	La función substring devuelve una pedezo de una cadena que va desde el índiceA, hasta el índiceB(no incluído)  
	 <br>`);
